...
ADAMS_exec = '' ;
ADAMS_host = 'AUM' ;
ADAMS_cwd ='C:\Users\BhaviK\Documents\GitHub\exoskeleton\load-analysis\LQR-control'  ;
ADAMS_prefix = 'lqr_control_plant' ;
ADAMS_static = 'no' ;
ADAMS_solver_type = 'C++' ;
...
ADAMS_pinput = 'lqr_control_plant.ctrl_pinput' ;
ADAMS_poutput = 'lqr_control_plant.ctrl_poutput' ;
ADAMS_uy_ids  = [
                   1
                   2
                   3
