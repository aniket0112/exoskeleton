...
!
file parasolid read  &
   file_name = "lqr_control_plant.xmt_txt"  &
   model_name = .Load_Test
!
geometry attributes  &
...
!
ude create instance  &
   instance_name = .Load_Test.lqr_control_plant  &
...
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.input_channels  &
   object_value =   &
      .Load_Test.Torque_rear,  &
      .Load_Test.Torque_front
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.output_channels  &
   object_value =   &
      .Load_Test.Theta_rear,  &
      .Load_Test.Theta_front
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.file_name  &
   string_value = "lqr_control_plant"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.solver_type  &
   string_value = "cplusplus"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.target  &
   string_value = "MATLAB"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.analysis_type  &
   string_value = "non_linear"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.analysis_init  &
   string_value = "no"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.analysis_init_str  &
   string_value = ""
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.user_lib  &
   string_value = ""
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.host  &
   string_value = "AUM"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.dynamic_state  &
   string_value = "on"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.tcp_ip  &
   string_value = "off"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.output_rate  &
   integer_value = 1
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.realtime  &
   string_value = "off"
!
variable modify  &
   variable_name = .Load_Test.lqr_control_plant.include_mnf  &
   string_value = "no"
!
ude modify instance  &
   instance_name = .Load_Test.lqr_control_plant
